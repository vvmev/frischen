window.onload = function() {
  ...
  switches["2a"] = new TurnoutRightTile("2b")
  switches["2b"] = new TurnoutRightReverseTile("2a")
  switches["3ab"] = new TurnoutRightTile("3c/d")
  switches["3cd"] = new TurnoutRightReverseTile("3a/b")
  switches["5a"] = new TurnoutLeftTile("5b")
  switches["5b"] = new TurnoutLeftReverseTile("5a")
  switches["6"] = new TurnoutLeftReverseTile("6")
  switches["GsI"] = new TurnoutLeftReverseTile("Gs I")
  ...
  tiles[1][3] = switches["2b"]
  tiles[1][4] = switches["2a"]
  ...
  tiles[1][10] = switches["5b"]
  tiles[1][11] = switches["5a"]
  ...
  tiles[2][4] = switches["3cd"]
  tiles[2][5] = switches["3ab"]
